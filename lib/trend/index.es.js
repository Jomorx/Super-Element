import { defineComponent, useSlots, onMounted, computed, openBlock, createElementBlock, createElementVNode, normalizeStyle, unref, renderSlot, toDisplayString, createBlock, resolveDynamicComponent } from "vue";
const toLine = (value) => {
...
var trend = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4f9c5051"]]);
var index = {
  install(app) {
