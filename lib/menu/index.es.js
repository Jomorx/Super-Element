...
import { defineComponent, resolveComponent, openBlock, createElementBlock, createVNode, mergeProps, withCtx, Fragment, renderList, createBlock, resolveDynamicComponent, unref, createCommentVNode, createElementVNode, toDisplayString, useAttrs, isVNode } from "vue";
const toLine = (value) => {
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.data, (item, i) => {
              return openBlock(), createElementBlock(Fragment, { key: i }, [
                !item[__props.children] || item[__props.children].length === 0 ? (openBlock(), createBlock(_component_el_menu_item, {
                  key: 0,
...
var menu = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-22dc85f4"]]);
