import { defineComponent, ref, watch, onMounted, resolveComponent, unref, openBlock, createBlock, mergeProps, withCtx, createElementBlock, Fragment, renderList, resolveDynamicComponent, createCommentVNode, renderSlot, createVNode, nextTick } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit: emits }) {
    ...
    const resetFields = () => {
      var _a;
      (_a = form.value) == null ? void 0 : _a.resetFields();
      if (props.options && props.options.length) {
    ...
    const onSuccess = (response, file, fileList) => {
      ...
      model.value[uploadItem == null ? void 0 : uploadItem.prop] = { response, file, fileList };
...
var index = {
  install(app) {
    app.component("se-form", _sfc_main);
  }
};
