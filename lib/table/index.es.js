import { defineComponent, computed, ref, watch, onMounted, resolveComponent, resolveDirective, openBlock, createElementBlock, Fragment, withDirectives, createBlock, mergeProps, unref, withCtx, renderList, createVNode, createElementVNode, withModifiers, renderSlot, toDisplayString, resolveDynamicComponent, createCommentVNode, normalizeStyle, isRef } from "vue";
const toLine = (value) => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  emits: ["confirm", "cancel", "update:editRowIndex", "sizeChange", "currentChange"],
                      ...
                      scope.$index + scope.column.id === unref(currentEdit) ? (openBlock(), createElementBlock("div", _hoisted_1, [
                        ...
                        createElementVNode("div", {
                          ...
                          _ctx.$slots.editCell ? renderSlot(_ctx.$slots, "editCell", {
                            key: 0,
                            scope
                          }, void 0, true) : (openBlock(), createElementBlock("div", _hoisted_3, [
                            createVNode(_component_el_icon_check, {
                              onClick: ($event) => confirm(scope),
                              class: "check"
                            }, null, 8, ["onClick"]),
                            createVNode(_component_el_icon_close, {
                              onClick: ($event) => cancel(scope),
                              class: "close"
                            }, null, 8, ["onClick"])
                          ]))
                        ], 8, _hoisted_2)
...
var table = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-52b30a72"]]);
var index = {
  install(app) {
