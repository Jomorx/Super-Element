import { defineComponent, ref, onMounted, resolveComponent, openBlock, createBlock, unref, withCtx, createElementVNode, isRef, toDisplayString, createVNode, normalizeClass, createElementBlock, Fragment, renderList, createTextVNode } from "vue";
var city = {
  cities: {
    A: [
      {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    const changeOption = (val) => {
      const values = Object.values(cities.value).flat(2);
      const city2 = values.find((item) => item.code === val);
      if (radioValue.value === "\u6309\u57CE\u5E02") {
                        ...
                        return openBlock(), createBlock(_component_el_row, {
                          ...
                          default: withCtx(() => [
                            ...
                            createVNode(_component_el_col, {
                              ...
                              default: withCtx(() => [
                                (openBlock(true), createElementBlock(Fragment, null, renderList(item1.cities, (item2, index22) => {
                                  return openBlock(), createElementBlock("div", {
...
var chooseCity = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0793e30a"]]);
var index = {
  install(app) {
