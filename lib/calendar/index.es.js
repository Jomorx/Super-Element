...
function g$1() {
  for (var n2; g$1.__r = t.length; )
    n2 = t.sort(function(n3, l2) {
      ...
      n3.__d && (o2 = (t2 = (l2 = n3).__v).__e, (r2 = l2.__P) && (u2 = [], (i = a$1({}, t2)).__v = t2.__v + 1, j$2(r2, t2, i, l2.__n, r2.ownerSVGElement !== void 0, t2.__h != null ? [o2] : null, u2, o2 == null ? k$1(t2) : o2, t2.__h), z$1(u2, t2), t2.__e != o2 && b$1(t2)));
    });
}
...
function S$1(u2, i, t2) {
  var o2, r2, f2;
  l$1.__ && l$1.__(u2, i), r2 = (o2 = typeof t2 == "function") ? null : t2 && t2.__k || i.__k, f2 = [], j$2(i, u2 = (!o2 && t2 || i).__k = v$1(d, null, [u2]), r2 || e$1, e$1, i.ownerSVGElement !== void 0, !o2 && t2 ? [t2] : r2 ? null : i.firstChild ? n.call(i.childNodes) : null, f2, !o2 && t2 ? t2 : r2 ? r2.__e : i.firstChild, o2), z$1(f2, u2);
}
function D$1(n2, l2) {
...
var u, r, o, c = [], f = l$1.__b, e = l$1.__r, a = l$1.diffed, v = l$1.__c, l = l$1.unmount;
function b() {
...
l$1.__b = function(n2) {
  ...
  u2.some(function(t3) {
    try {
      t3.__H && t3.__H.__.forEach(function(n2) {
...
l$1.vnode = function(n2) {
  ...
  if (typeof t2 == "string") {
    ...
    for (var o2 in r2 = {}, e2) {
      var i = e2[o2];
      j && o2 === "children" && t2 === "noscript" || o2 === "value" && "defaultValue" in e2 && i == null || (o2 === "defaultValue" && "value" in e2 && e2.value == null ? o2 = "value" : o2 === "download" && i === true ? i = "" : /ondoubleclick/i.test(o2) ? o2 = "ondblclick" : /^onchange(textarea|input)/i.test(o2 + t2) && !z(e2.type) ? o2 = "oninput" : /^onfocus$/i.test(o2) ? o2 = "onfocusin" : /^onblur$/i.test(o2) ? o2 = "onfocusout" : /^on(Ani|Tra|Tou|BeforeInp|Compo)/.test(o2) ? o2 = o2.toLowerCase() : u2 && V.test(o2) ? o2 = o2.replace(/[A-Z0-9]/, "-$&").toLowerCase() : i === null && (i = void 0), /^oninput/i.test(o2) && (o2 = o2.toLowerCase(), r2[o2] && (o2 = "oninputCapture")), r2[o2] = i);
    }
...
var index = {
  install(app) {
    app.component("se-calendar", _sfc_main);
  }
};
