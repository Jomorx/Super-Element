      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createElementVNode("div", _hoisted_2, [
          createVNode(_component_el_date_picker, mergeProps({
            ...
            "disabled-date": unref(startDisabledDate)
          }, _ctx.$attrs.startOptions), null, 16, ["modelValue", "placeholder", "disabled-date"])
        ]),
        createElementVNode("div", null, [
          createVNode(_component_el_date_picker, mergeProps({
            ...
            "disabled-date": unref(endDisabledDate)
          }, _ctx.$attrs.endOptions), null, 16, ["modelValue", "placeholder", "disabled", "disabled-date"])
        ])
      ]);
    };
  }
...
var index = {
  install(app) {
    app.component("se-choose-date", _sfc_main);
  }
};
